...
import static com.sku.road.zolzak.armap.TiemTable.REQUEST_CODE;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                Double longtde = (Double)data.getSerializableExtra("longitude");
                Double latide = (Double) data.getSerializableExtra("latitude");

                final Point ROUTE_DESTINATION = Point.fromLngLat(longtde, latide);
            }
        }
    }
